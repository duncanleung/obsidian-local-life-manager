...
4. Create session file with `"type": "review"` per `../learn-shared/references/session-schema.md`
5. Update index.json
...
4. Log `retrieval_test` entries per `../learn-shared/references/entry-types.md`
...
Per `../learn-shared/references/proficiency.md`:
