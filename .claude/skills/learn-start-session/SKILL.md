...
6. Create session file per `../learn-shared/references/session-schema.md`
7. Update index.json
...
- Log as `retrieval_attempt` entry (see `../learn-shared/references/entry-types.md`)
...
Log entries per `../learn-shared/references/entry-types.md`. Use `/learn-log-session` for long sessions.

## End

Use `/learn-end-session` when done.
