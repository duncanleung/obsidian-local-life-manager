...
Help process notes in `01 Inbox/`.
...
| `05 Personal/` | Personal notes, decisions, career |
| `06 Projects/` | Active project notes |
| `07 Knowledge Base/` | Courses, tech notes, references |
