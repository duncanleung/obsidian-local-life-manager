...
Help the user decide what to work on right now.
...
2. **Check today's journal** (`02 Calendar/YYYY-MM-DD.md`)
   - Is there a highlight set?
   - What's already been done today?

3. **Check project status** (scan `"06 Projects"/*/README.md` for active projects)
   - Any urgent issues?
