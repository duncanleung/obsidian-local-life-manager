...
```
/project-issue → /project-plan → /project-teach → [you implement with learning] → /project-worklog → quality gate → /project-commit → /project-complete
```

Mixed approach:
```
/project-teach (new concepts) → /project-advise (applying) → /project-implement (repetitive)
```
