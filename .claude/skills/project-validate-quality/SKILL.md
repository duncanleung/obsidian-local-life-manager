---
name: project-validate-quality
description: "Comprehensive code quality assessment in project code repo (from Projects Index). Use before commits, merges, or releases to ensure consistent quality."
...
# e.g., /Users/duncanleung/Develop/[project]/
```

### 2. Run Automated Checks

```bash
# cd to code path from Projects Index
npm test -- --coverage
npm run lint
