---
name: project-validate-troubleshoot
description: "Systematic debugging with 5-step loop for issues in project code repo (from Projects Index). Use when encountering bugs, test failures, or unexpected behavior."
...
Glob: "06 Projects"/[project]/notes/research/*.md

# Search for similar issues in codebase
# (legacy reference - use code repo path below instead)

# Check library docs via Context7
# WebSearch for error messages, known issues

# Search in code repo (resolved from Projects Index)
Grep: [code-repo-path]/ for error message
```
...
```
/project-implement → (issue occurs) → /project-validate-troubleshoot → /project-worklog → /project-implement
```
