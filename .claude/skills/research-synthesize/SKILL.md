...
All synthesis documents go in: `07 Knowledge Base/Synthesis/[Topic]/`

Structure:
```
07 Knowledge Base/Synthesis/
└── ADHD/
...
Queues live in: `.claude/skills/research-synthesize/references/queues/[topic].json`
...
```json
{
  ...
  "watch_patterns": [
    "01 Inbox/Videos/**/*ADHD*.md",
    "01 Inbox/*adhd*.md",
    "05 Personal/Health/*ADHD*.md"
  ],
  "sources": [
    {"path": "path/to/note.md", "status": "pending", "type": "local"},
    {"path": "path/to/video.md", "status": "processed", "type": "local"},
...
**Source types:**
- `local` - Path to existing note in the vault
...
Create at: `07 Knowledge Base/Synthesis/[Topic]/[Topic] Synthesis.md`
...
Create at: `07 Knowledge Base/Synthesis/[Topic]/[Topic] Sources.md`
...
### Manual Addition
```
/synthesize add adhd path/to/specific/note.md
```

### Glob Pattern
```
/synthesize add adhd "01 Inbox/Videos/**/*ADHD*.md"
```
