...
description: End-of-session reflection. Extracts memories, suggests updates to about-me.md and CLAUDE.md. Run before ending a long session or when context is getting full. Triggers on "debrief", "extract memories", "session summary".
...
1. **Read current state:**
   - `.claude/obsidian-memories/about-me.md` - Current profile
   - `.claude/obsidian-memories/index.json` - Existing memories
...
- How the user actually uses tools vs. assumptions
...
**Category:** preference
**Content:** The user prefers X over Y because Z.
**Source:** [Quote or paraphrase from conversation]

Action? [Save / Skip / Edit]
```

### Phase 4: Updates to about-me.md
...
**Remember:** about-me.md has a 300-line limit. Only add significant, lasting information.
...
1. Create JSON file: `.claude/obsidian-memories/YYYY-MM-DD-NNN.json`
   ```json
   {
     "date": "YYYY-MM-DD",
   ...
   ```
2. Update `.claude/obsidian-memories/index.json`
...
```json
{
  "date": "2026-01-20",
  "category": "preference",
  "content": "The user prefers not to over-engineer tooling for rare edge cases.",
  "source": "conversation"
}
```
